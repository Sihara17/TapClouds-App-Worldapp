...
export default function TapCloud() {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-no-repeat relative overflow-hidden" style={{ backgroundImage: "url('/bg-Cloud.png')" }}>
      ...
      <div className="text-[#1e3a8a] relative z-10">
        ...
        <div className="text-center mb-6">
          ...
          <div className="mb-6">
            <p className="mb-1">Season 1 Final Point</p>
          ...
          <Card className="bg-gradient-to-r from-purple-600 to-blue-600 border-none p-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-yellow-400 rounded-lg flex items-center justify-center">
                <div className="w-8 h-8 bg-yellow-500 rounded transform rotate-45" />
              </div>
              <div className="flex-1">
                <h3 className="font-semibold text-white">Drop Wallet : Get up to 10 HUB</h3>
                <p className="text-sm text-white/80">Check in daily, swap tokens, earn HUB</p>
              </div>
            </div>
          </Card>
        </div>

        <div className="fixed bottom-0 left-0 right-0 bg-white/70 backdrop-blur-sm border-t border-gray-200">
          <div className="flex items-center justify-around py-3 text-[#1e3a8a]">
            <Button variant="ghost" className="flex flex-col items-center gap-1">
              <Home className="h-6 w-6" />
              <span className="text-xs">Home</span>
            </Button>
            <Button variant="ghost" className="flex flex-col items-center gap-1 opacity-60">
